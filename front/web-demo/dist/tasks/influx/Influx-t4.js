...
/*
 ...
 <!-- Oppgave 4 influx -->
    <div id="page-influx-t4" class="page-view">
      <h1 class="page-title">InfluxDB - Oppgave 4</h1>

    <!-- startpage -->
    <div id="influxT4-startPage" class="infobox">
        <h4>Tidsserie sortering</h4>
        <p>Plasser sensorboksene fra venstre side i riktig rekkefølge i bucket (databasen) på høyre side. Nyeste tidsstempel øverst.</p>
        <p>Riktig plassering gir +1 poeng. Feil gir -1 poeng.</p>
        <p>Bucket er en navngitt database i InfluxDB. Det er en samling der alle relevante sensormålinger samles ett sted og sorteres etter tid.</p>
        <button class="startbtn" onclick="influxT4Start()">Start</button>
    </div>

    <!-- taskpage -->
    <div id="influxT4Page">
        <!-- poeng -->
        <div id="influxT4-poeng">Poeng: 0 — Found: 0/6</div>
        <!-- venstre og høyre side layout-->
        <div id="influxT4-layout">
            <!-- venstre side med  sensorbokser -->
            <div id="venstreSide"></div>
            <!-- høyre side med database -->
            <div id="høyreSide">
                <div class="bucketTittel">Bucket: sensor_data</div>
                <div id="databaseRader"></div>
            </div>

        </div>
    </div>

    <button class="small-link" onclick="go('influx')">← Tilbake</button>
</div>


<script src="tasks/influx/influx-t4.js"></script>

"influx-t4": "Sorter tempratur-målingene inn i tidsserie-databasen i riktig rekkefølge.",

<link rel="stylesheet" href="tasks/influx/influx-t4.css">
